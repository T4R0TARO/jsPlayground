...
const range1 = createRange(3, 7)
const range2 = createRange(1, 10)
const range3 = createRange(20, 30)
console.log(range1, range2, range3)


// Check if the last array you created is really an array with Array.isArray();
console.log(Array.isArray(range1))
...
console.log(meatsAtLeast5) // returns true
...
function numberSorted(a, b) {
    return a - b
}

console.log(orderTotals.sort(numberSorted))
