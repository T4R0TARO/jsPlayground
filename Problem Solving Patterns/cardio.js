...
function maxCharacter(str){
  ...
  // console.log(charMap)
  return `char: ${maxChar} has ${maxNum}`
}
...
function longestWord(sen) {
  ...
  //if multiple words, put in arr
  /**
   * filter()
   * check if any of the sorted word have the same length as the first sorted word
   * if so, put longestWords in arr
   */
